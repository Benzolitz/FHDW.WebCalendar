	...
	<div id="divRegistration">
		...
		<div id="divContent">
			<form name="frmLogin" method="post" action="RegisterController">
				<div class="divCenter">
					<input id="txtUsername" name="txtUsername" class="claUserdata claRequiredField" type="text" value="<% String username = request.getParameter("username"); if(username != null) out.print(username);%>" placeholder="Benutzername*" />
				</div>
				<div class="divCenter">
					<input id="txtPassword" name="txtPassword" class="claUserdata claRequiredField" type="password" placeholder="Passwort*" />
				</div>
				<div class="divCenter">
					<input id="txtPasswordCheck" name="txtPasswordCheck" class="claUserdata claRequiredField" type="password" placeholder="Passwort wiederholen*" />
				</div>
				<div class="divCenter">
					<input id="txtUsermail" name="txtUsermail" class="claUserdata claRequiredField" type="text" placeholder="E-Mailadresse*" />
				</div>
				<div class="divCenter">
					<input id="txtUserFirstname" name="txtUserFirstname" class="claUserdata" type="text" placeholder="Vorname" />
				</div>
				<div class="divCenter">
					<input id="txtUserLastname" name="txtUserLastname" class="claUserdata" type="text" placeholder="Nachname" />
				</div>
				<div class="divCenter">
