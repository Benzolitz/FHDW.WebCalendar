	...
	<div id="appointment">
		...
		<form name="appointmentForm" action="EventController" method="post">
			<div id="fields" style="width: 80%; height: 50%; float: left; margin-top: 5px;">
				...
				<span class="fa fa-clock-o" style="margin-right: 2px; margin-left: 7px;"></span> <input type="text" name="appointmentStart"placeholder="Start" /> 
				<span class="fa fa-clock-o" style="margin-right: 4px; margin-left: 6px;"></span> <input type="text" name="appointmentEnd" placeholder="Ende" /><br /> 
				<span class="fa fa-building" style="margin-right: 2px; margin-left: 7px;"></span> <input type="text" name="appointmentLocation" placeholder="Ort" /><br /> 
				<span class="fa fa-users" style="margin-right: 1px;"></span> <input type="text" name="appointmentRequired" style="width: 545px;" placeholder="Erforderlich" /><br /> 
				<span class="fa fa-user-plus"></span> <input type="text" name="appointmentOptional" style="width: 545px;" placeholder="Optional" /><br />
			</div>
