...
var WindowTitle = "Zeitpunkt wählen";// Date Time Picker title.
...
function NewCal(pCtrl, pFormat, pShowTime, pTimeMode) {
  ...
  if (exDateTime != "")// Parse Date String
  {
    ...
    if ((parseInt(strDate, 10) <= Cal.GetMonDays())
            && (parseInt(strDate, 10) >= 1)) Cal.Date = strDate;
    // end parse Date
    // parse year
...
function GenCell(pValue, pHighLight, pColor)// Generate table cell with value
{
  ...
  PCellStr = "<td " + vColor + " width=" + CellWidth
          ...
          + "<a href=\"javascript:winMain.document.getElementById('" + Cal.Ctrl
          + "').value='" + Cal.FormatDate(PValue) + "';" + vTimeStr
          + ";window.close();\">" + PValue + "</a>" + vHLstr2 + "</font></td>";
  return PCellStr;
}
